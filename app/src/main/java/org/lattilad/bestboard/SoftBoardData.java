...
import org.lattilad.bestboard.parser.MethodsForCommands;
...
public class SoftBoardData
    ...
    /**
     * Copy of {@link MethodsForCommands#layouts} (after parsing is finished)
     * This list is needed to reach each layout and button to connect them to Service
     */
    ...
    public final static int VIBRATE_REPEATED = 3;
    ...
    public void connect(SoftBoardListener softBoardListener)
        ...
        // each layout should be reached to connect buttons
   ...
   /**
    ...
    public void vibrate( int type )
        ...
        if ( vibrationAllowed )
            ...
            if (length > 0) // Otherwise: Failed to create VibrationEffect
                            // java.lang.IllegalArgumentException: duration must be positive (duration=0)
