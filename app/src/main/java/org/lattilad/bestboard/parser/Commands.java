...
public class Commands
    ...
    public static final long TOKEN_NORTH = 0x2a5df03L;
    public static final long TOKEN_EAST = 0xc0bb8L;
    public static final long TOKEN_SOUTH = 0x334ebc3L;
    public static final long TOKEN_WEST = 0x1a0aa6L;

    public static final long TOKEN_HEXR = 0xe736aL;
    public static final long TOKEN_HEXDR = 0x1f2ac8bL;
    public static final long TOKEN_HEXDL = 0x1f2ac85L;
    public static final long TOKEN_HEXL = 0xe7364L;
    public static final long TOKEN_HEXUL = 0x1f2aefaL;
    public static final long TOKEN_HEXUR = 0x1f2af00L;

    public static final long TOKEN_HEXU = 0xe736dL;
    public static final long TOKEN_HEXRU = 0x1f2ae94L;
    public static final long TOKEN_HEXRD = 0x1f2ae83L;
    public static final long TOKEN_HEXD = 0xe735cL;
    public static final long TOKEN_HEXLD = 0x1f2ada5L;
    public static final long TOKEN_HEXLU = 0x1f2adb6L;

    public static final long TOKEN_CLOCK1 = 0x34059d89L;
    public static final long TOKEN_CLOCK2 = 0x34059d8aL;
    public static final long TOKEN_CLOCK3 = 0x34059d8bL;
    public static final long TOKEN_CLOCK4 = 0x34059d8cL;
    public static final long TOKEN_CLOCK5 = 0x34059d8dL;
    public static final long TOKEN_CLOCK6 = 0x34059d8eL;
    public static final long TOKEN_CLOCK7 = 0x34059d8fL;
    public static final long TOKEN_CLOCK8 = 0x34059d90L;
    public static final long TOKEN_CLOCK9 = 0x34059d91L;
    public static final long TOKEN_CLOCK10 = 0x784abc4f1L;
    public static final long TOKEN_CLOCK11 = 0x784abc4f2L;
    public static final long TOKEN_CLOCK12 = 0x784abc4f3L;
    ...
    public static final long TOKEN_MOD = 0x1792aL;
    ...
    public static final long TOKEN_STICKY = 0x77076f54L;
    public static final long TOKEN_JOY = 0x16934L;
    ...
    // There is a special switch packet called JUMP
    public static final long TOKEN_JUMP = 0x10531bL;
    ...
    public static final long TOKEN_TOSTICKY = 0x28fca5faca5L;
    public static final long TOKEN_TOJOY = 0x3514939L;

    public static final long TOKEN_CLEARTITLES = 0xd6e06d22d81322L;
    ...
    public static Map<Long, Data> createDataMap()
        ...
        add(TOKEN_BLOCK, new long[]{
                ...
                TOKEN_STICKY | PARAMETER_MOD_MULTIPLE,
                TOKEN_JOY | PARAMETER_MOD_MULTIPLE,
        ...
        add(TOKEN_NORTH, packetArray)
                .allowAsLabel().allowAsDefault().labels(new long[]{TOKEN_PACKET})
                .method("packet");
        add(TOKEN_EAST, packetArray)
                .allowAsLabel().allowAsDefault().labels(new long[]{TOKEN_PACKET})
                .method("packet");
        add(TOKEN_SOUTH, packetArray)
                .allowAsLabel().allowAsDefault().labels(new long[]{TOKEN_PACKET})
                .method("packet");
        add(TOKEN_WEST, packetArray)
                .allowAsLabel().allowAsDefault().labels(new long[]{TOKEN_PACKET})
                .method("packet");

        add(TOKEN_HEXR, packetArray)
                .allowAsLabel().allowAsDefault().labels(new long[]{TOKEN_PACKET})
                .method("packet");
        add(TOKEN_HEXDR, packetArray)
                .allowAsLabel().allowAsDefault().labels(new long[]{TOKEN_PACKET})
                .method("packet");
        add(TOKEN_HEXDL, packetArray)
                .allowAsLabel().allowAsDefault().labels(new long[]{TOKEN_PACKET})
                .method("packet");
        add(TOKEN_HEXL, packetArray)
                .allowAsLabel().allowAsDefault().labels(new long[]{TOKEN_PACKET})
                .method("packet");
        add(TOKEN_HEXUL, packetArray)
                .allowAsLabel().allowAsDefault().labels(new long[]{TOKEN_PACKET})
                .method("packet");
        add(TOKEN_HEXUR, packetArray)
                .allowAsLabel().allowAsDefault().labels(new long[]{TOKEN_PACKET})
                .method("packet");

        add(TOKEN_HEXU, packetArray)
                .allowAsLabel().allowAsDefault().labels(new long[]{TOKEN_PACKET})
                .method("packet");
        add(TOKEN_HEXRU, packetArray)
                .allowAsLabel().allowAsDefault().labels(new long[]{TOKEN_PACKET})
                .method("packet");
        add(TOKEN_HEXRD, packetArray)
                .allowAsLabel().allowAsDefault().labels(new long[]{TOKEN_PACKET})
                .method("packet");
        add(TOKEN_HEXD, packetArray)
                .allowAsLabel().allowAsDefault().labels(new long[]{TOKEN_PACKET})
                .method("packet");
        add(TOKEN_HEXLD, packetArray)
                .allowAsLabel().allowAsDefault().labels(new long[]{TOKEN_PACKET})
                .method("packet");
        add(TOKEN_HEXLU, packetArray)
                .allowAsLabel().allowAsDefault().labels(new long[]{TOKEN_PACKET})
                .method("packet");

        add(TOKEN_CLOCK1, packetArray)
                .allowAsLabel().allowAsDefault().labels(new long[]{TOKEN_PACKET})
                .method("packet");
        add(TOKEN_CLOCK2, packetArray)
                .allowAsLabel().allowAsDefault().labels(new long[]{TOKEN_PACKET})
                .method("packet");
        add(TOKEN_CLOCK3, packetArray)
                .allowAsLabel().allowAsDefault().labels(new long[]{TOKEN_PACKET})
                .method("packet");
        add(TOKEN_CLOCK4, packetArray)
                .allowAsLabel().allowAsDefault().labels(new long[]{TOKEN_PACKET})
                .method("packet");
        add(TOKEN_CLOCK5, packetArray)
                .allowAsLabel().allowAsDefault().labels(new long[]{TOKEN_PACKET})
                .method("packet");
        add(TOKEN_CLOCK6, packetArray)
                .allowAsLabel().allowAsDefault().labels(new long[]{TOKEN_PACKET})
                .method("packet");
        add(TOKEN_CLOCK7, packetArray)
                .allowAsLabel().allowAsDefault().labels(new long[]{TOKEN_PACKET})
                .method("packet");
        add(TOKEN_CLOCK8, packetArray)
                .allowAsLabel().allowAsDefault().labels(new long[]{TOKEN_PACKET})
                .method("packet");
        add(TOKEN_CLOCK9, packetArray)
                .allowAsLabel().allowAsDefault().labels(new long[]{TOKEN_PACKET})
                .method("packet");
        add(TOKEN_CLOCK10, packetArray)
                .allowAsLabel().allowAsDefault().labels(new long[]{TOKEN_PACKET})
                .method("packet");
        add(TOKEN_CLOCK11, packetArray)
                .allowAsLabel().allowAsDefault().labels(new long[]{TOKEN_PACKET})
                .method("packet");
        add(TOKEN_CLOCK12, packetArray)
                .allowAsLabel().allowAsDefault().labels(new long[]{TOKEN_PACKET})
                .method("packet");
        ...
        // Modify packet is NOT a one-parameter command,
        // it has got two parameters: (Like MODIFY BUTTON)
        add(TOKEN_MOD, new long[]{
                TOKEN_ROLL, TOKEN_REVERSE })
                .method("packetModify").allowAsLabel().allowAsDefault();
        // The result (as MOD parameter - PacketModify java type)
        // will be part of the whole packet list (PACKET, FIRST, SECOND, BUTTON...) - Really?
        ...
        // Jump is a special packet derived from SWITCH BUTTON
        add(TOKEN_JUMP, new long[]{
                TOKEN_BOARD, TOKEN_BACK, TOKEN_LOCK })
                .method("packetJump").allowAsLabel().allowAsDefault();
        ...
        add(TOKEN_STICKY, ArrayUtils.concat(packetArray, buttonArray, new long[]{
                ...
                TOKEN_HEXU, TOKEN_HEXRU, TOKEN_HEXRD, TOKEN_HEXD, TOKEN_HEXLD, TOKEN_HEXLU,
                ...
                TOKEN_REPEAT }))
                .method("setSticky").group(TOKEN_BUTTON).allowAsLabel().allowAsDefault()
                .labels(new long[]{TOKEN_BUTTON, TOKEN_PACKET, TOKEN_FIRST, TOKEN_SECOND,
                        TOKEN_NORTH, TOKEN_EAST, TOKEN_SOUTH, TOKEN_WEST,
                        TOKEN_HEXR, TOKEN_HEXDR, TOKEN_HEXDL, TOKEN_HEXL, TOKEN_HEXUL, TOKEN_HEXUR,
                        TOKEN_HEXU, TOKEN_HEXRU, TOKEN_HEXRD, TOKEN_HEXD, TOKEN_HEXLD, TOKEN_HEXLU,
        ...
        add(TOKEN_JOY, ArrayUtils.concat(packetArray, buttonArray, new long[]{
                TOKEN_FIRST,
                TOKEN_NORTH,
                TOKEN_EAST,
                TOKEN_SOUTH,
                TOKEN_WEST }))
                .method("setStickyJoy").group(TOKEN_BUTTON).allowAsLabel().allowAsDefault()
                .labels(new long[]{TOKEN_BUTTON, TOKEN_PACKET, TOKEN_FIRST,
                        TOKEN_NORTH, TOKEN_EAST, TOKEN_SOUTH, TOKEN_WEST});
        ...
        add(TOKEN_TOSTICKY, PARAMETER_FLAG );
        add(TOKEN_TOJOY, PARAMETER_FLAG );

        add(TOKEN_CLEARTITLES, PARAMETER_FLAG );
