...
public abstract class Modify
    ...
    public boolean change( boolean reverse )
        ...
        // modified character cannot be undo-ed - because undo should re-convert the character, which is NOT implemented
        softBoardData.softBoardListener.clearUndoString();
